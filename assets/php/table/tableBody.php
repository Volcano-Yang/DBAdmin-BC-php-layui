...
if ($query_tableBody) {
    ...
    while ($row2 = mysqli_fetch_assoc($query_tableBody)) {
        ...
        $tableBody .= "<td style='text-align:center;vertical-align: middle!important;'> <a href='../pages/updataform.php?addtable=" . $tablename . "&addid=" . $tableHeaderArr2[0] . "&addvalue=" . $row2[$tableHeaderArr2[0]] . "'><img src='../../../img/updata.png' style='width:1.0rem;'></a> </td>";
        $tableBody .= '</tr>';
    }
} else {
